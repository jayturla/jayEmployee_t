...
//import tooltwist.jay.productionHelpers.MenuProductionHelper;
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "menu_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "menu_jsHeader.js")),
...
//		rh.afterProductionCode(generator, instance);
		...
		for(Navpoint nav: children) {
				...
				//condition for the getting the navpoint ID status
