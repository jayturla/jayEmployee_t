...
//import tooltwist.jay.productionHelpers.ReserveProductionHelper;
 ...
 * reserve
 */
public class ReserveWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "reserve_preview.html";
	private static final String SNIPPET_DESIGN = "reserve_design.html";
	private static final String SNIPPET_PRODUCTION = "reserve_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "reserve_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "reserve_jsHeader.js")),
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, ReserveProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(ReserveProductionHelper.class.getName()));
			}
		}
