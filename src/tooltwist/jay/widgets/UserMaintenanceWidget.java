...
import tooltwist.jay.productionHelpers.UserMaintenanceProductionHelper;
import com.dinaa.ui.UimData;
import com.dinaa.ui.UimHelper;

/**
 * User Maintenance Widget
 */
public class UserMaintenanceWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "userMaintenance_preview.html";
	private static final String SNIPPET_DESIGN = "userMaintenance_design.html";
	private static final String SNIPPET_PRODUCTION = "userMaintenance_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator,instance, "userMaintenance_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator,instance, "userMaintenance_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, UserMaintenanceProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(UserMaintenanceProductionHelper.class.getName()));
			}
		}
