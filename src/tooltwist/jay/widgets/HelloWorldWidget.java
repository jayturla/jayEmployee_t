...
//import tooltwist.jay.productionHelpers.HelloWorldProductionHelper;
...
public class HelloWorldWidget extends WbdWidgetController
{
	...
	protected void init(WbdWidget instance) throws WbdException
	{
		...
		instance.defineProperty(new WbdStringProperty("name", null, "Enter First Name", ""));
		instance.defineProperty(new WbdStringProperty("m_name", null, "Enter Middle Name", ""));
		instance.defineProperty(new WbdStringProperty("l_name", null, "Enter Last Name", ""));
...
//				codeInserterList.add(new PageImportCodeInserter(HelloWorldProductionHelper.class.getName()));
	...
	private SnippetParam[] getSnippetParams(WbdGenerator generator, WbdWidget instance, UimData ud) throws WbdException {
		String myName = instance.getProperty("name", null);
		String mymName = instance.getProperty("m_name", null);
		String mylName = instance.getProperty("l_name", null);
//		String myNavpoint = instance.getProperty("myNavpoint", null);
		SnippetParam[] params = {
			new SnippetParam("myName", myName),
			new SnippetParam("mymName", mymName),
			new SnippetParam("mylName", mylName),
